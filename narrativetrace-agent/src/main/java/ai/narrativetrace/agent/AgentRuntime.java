...
public final class AgentRuntime {
    ...
    public static void enterMethod(String className, String methodName,
                                   ...
                                   boolean[] redacted, String narratedTemplate) {
        ...
        context.enterMethod(new MethodSignature(className, methodName,
                List.copyOf(captures), narration, null));
    }

    private static List<ParameterCapture> buildCaptures(String[] paramNames, Object[] paramValues,
                                                        boolean[] redacted) {
    ...
    private static String resolveNarration(String template, String[] paramNames,
                                           Object[] paramValues, boolean[] redacted) {
        if (template == null) {
            return null;
        }
    ...
    public static String resolveErrorContext(Throwable exception,
    ...
    private static String findBestTemplate(Throwable exception,
                                           String[] templates, String[] exceptionDescriptors) {
