...
public final class RoleSuffixDictionary {
    ...
    public enum Category { DESIGN_PATTERN, FUNCTIONAL, GENERIC, UNKNOWN }

    public record Result(Category category, double score) {}

    private static final Set<String> DESIGN_PATTERN_SUFFIXES = Set.of(
            "service", "repository", "controller", "factory", "builder", "strategy",
            "observer", "adapter", "decorator", "visitor", "command", "facade",
            "proxy", "gateway", "client"
    );

    private static final Set<String> FUNCTIONAL_SUFFIXES = Set.of(
            "validator", "converter", "mapper", "resolver", "provider", "listener",
            "interceptor", "filter", "scheduler", "dispatcher", "router", "registry",
            "store", "cache", "engine", "renderer", "executor", "analyzer", "scanner",
            "parser", "formatter", "encoder", "decoder", "serializer", "loader",
            "exporter", "importer", "inspector", "monitor", "notifier", "publisher",
            "consumer", "producer", "transformer", "translator", "generator",
            "authenticator", "authorizer", "coordinator", "aggregator"
    );

    private static final Set<String> GENERIC_SUFFIXES = Set.of(
            "manager", "handler", "processor", "helper", "utility", "utils", "util",
            "common", "base", "default", "data", "info", "impl"
    );

    private static final Map<String, List<String>> EXPECTED_VERBS = Map.ofEntries(
            Map.entry("repository", List.of("find", "save", "delete", "exists", "count", "get")),
            Map.entry("factory", List.of("create", "build", "make", "of", "from", "new")),
            Map.entry("builder", List.of("create", "build", "make", "of", "from", "with", "set", "add")),
            ...
            Map.entry("controller", List.of("create", "read", "update", "delete", "list", "get", "find", "save")),
            ...
            Map.entry("registry", List.of("register", "unregister", "lookup", "find", "get", "contains"))
    );
