...
public final class GenericTokenDetector {
    ...
    public enum Tier { MEANINGLESS, VAGUE, TYPED_GENERIC, NOT_GENERIC }

    public record Result(Tier tier, double score) {}

    private static final Set<String> MEANINGLESS_PLACEHOLDERS = Set.of(
            "foo", "bar", "baz", "qux", "quux", "temp", "tmp", "test",
            "dummy", "sample", "example", "xxx", "yyy", "zzz"
    );
    ...
    private static final Set<String> TYPED_GENERIC_WORDS = Set.of(
            ...
            "collection", "table", "row", "column", "field", "property",
            "tag", "version", "timestamp", "date", "time", "duration",
            "interval", "timeout", "limit", "offset", "page", "sort",
            "order", "direction", "position", "priority", "weight", "rank",
            "score", "rating", "percentage", "ratio", "factor", "coefficient"
    );
