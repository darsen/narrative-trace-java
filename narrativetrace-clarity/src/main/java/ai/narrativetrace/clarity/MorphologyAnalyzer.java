...
public final class MorphologyAnalyzer {
    ...
    public enum PartOfSpeech { VERB, NOUN, ADJECTIVE, UNKNOWN }

    public record Result(PartOfSpeech partOfSpeech) {}

    private static final int MIN_SUFFIX_LENGTH = 4;

    private static final List<String> VERB_SUFFIXES = List.of(
            "ate", "ize", "ise", "ify", "en"
    );

    private static final List<String> NOUN_SUFFIXES = List.of(
