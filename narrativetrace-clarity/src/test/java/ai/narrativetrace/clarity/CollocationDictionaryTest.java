...
class CollocationDictionaryTest {
    ...
    void financeAccountHasExpectedVerbs() {
        ...
        assertThat(verbs).containsExactlyInAnyOrder(
                "debit", "credit", "balance", "close", "reconcile", "freeze");
    }
    ...
    void financeLoanHasExpectedVerbs() {
        ...
        assertThat(verbs).containsExactlyInAnyOrder(
                "originate", "underwrite", "amortize", "service", "default");
    }
    ...
    void ecommerceOrderHasExpectedVerbs() {
        ...
        assertThat(verbs).containsExactlyInAnyOrder(
                "place", "fulfill", "cancel", "ship", "return", "backorder");
    }
    ...
    void ecommerceCartHasExpectedVerbs() {
        ...
        assertThat(verbs).containsExactlyInAnyOrder(
                "add", "remove", "empty", "checkout", "abandon");
    }
    ...
    void ecommerceInventoryHasExpectedVerbs() {
        ...
        assertThat(verbs).containsExactlyInAnyOrder(
                "replenish", "reserve", "deplete", "count", "restock");
    }
    ...
    void healthcarePatientHasExpectedVerbs() {
        ...
        assertThat(verbs).containsExactlyInAnyOrder(
                "admit", "discharge", "refer", "triage", "diagnose", "treat");
    }
    ...
    void healthcareMedicationHasExpectedVerbs() {
        ...
        assertThat(verbs).containsExactlyInAnyOrder(
                "prescribe", "administer", "dispense", "discontinue", "titrate");
    }
    ...
    void hospitalityReservationHasExpectedVerbs() {
        ...
        assertThat(verbs).containsExactlyInAnyOrder(
                "book", "confirm", "cancel", "modify", "honor", "overbook");
    }
    ...
    void gamingPlayerHasExpectedVerbs() {
        ...
        assertThat(verbs).containsExactlyInAnyOrder(
                "spawn", "respawn", "ban", "kick", "matchmake", "rank");
    }
    ...
    void logisticsShipmentHasExpectedVerbs() {
        ...
        assertThat(verbs).containsExactlyInAnyOrder(
                "dispatch", "track", "reroute", "deliver", "return", "insure");
    }
    ...
    void educationStudentHasExpectedVerbs() {
        ...
        assertThat(verbs).containsExactlyInAnyOrder(
                "enroll", "expel", "graduate", "mentor", "counsel", "assess");
    }
    ...
    void realEstatePropertyHasExpectedVerbs() {
        ...
        assertThat(verbs).containsExactlyInAnyOrder(
                "list", "appraise", "inspect", "close", "escrow", "foreclose");
    }
    ...
    void securityAndBlockchainTokenVerbsAreMerged() {
        ...
        assertThat(verbs).containsExactlyInAnyOrder(
                "issue", "revoke", "refresh", "rotate", "invalidate", "blacklist",
                "mint", "burn", "stake", "transfer", "vest", "lock");
    }
    ...
    void dataDatasetHasExpectedVerbs() {
        ...
        assertThat(verbs).containsExactlyInAnyOrder(
                "ingest", "cleanse", "partition", "sample", "anonymize");
    }
    ...
    void contentArticleHasExpectedVerbs() {
        ...
        assertThat(verbs).containsExactlyInAnyOrder(
                "draft", "publish", "archive", "retract", "syndicate");
    }
    ...
    void socialUserHasExpectedVerbs() {
        ...
        assertThat(verbs).containsExactlyInAnyOrder(
                "follow", "unfollow", "block", "mute", "report", "verify");
    }
    ...
    void legalAndBlockchainContractVerbsAreMerged() {
        ...
        assertThat(verbs).containsExactlyInAnyOrder(
                "draft", "sign", "amend", "terminate", "enforce", "breach",
                "deploy", "verify", "audit", "upgrade", "pause");
    }
    ...
    void manufacturingBatchHasExpectedVerbs() {
        ...
        assertThat(verbs).containsExactlyInAnyOrder(
                "start", "inspect", "reject", "release", "quarantine");
    }
    ...
    void energyGridHasExpectedVerbs() {
        ...
        assertThat(verbs).containsExactlyInAnyOrder(
                "balance", "stabilize", "shed", "curtail", "interconnect");
    }
