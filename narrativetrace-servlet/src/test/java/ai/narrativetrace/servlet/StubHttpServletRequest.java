...
@SuppressWarnings("PMD") // Test stub — only method/URI are meaningful
class StubHttpServletRequest implements HttpServletRequest {
    ...
    StubHttpServletRequest(String method, String requestURI) {
        this.method = method;
    ...
    @Override public StringBuffer getRequestURL() { return new StringBuffer("http://localhost" + requestURI); }
