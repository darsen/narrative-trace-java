...
public class ContextOverheadBenchmark {
    ...
    private static final MethodSignature SIGNATURE =
            new MethodSignature("TestService", "execute",
                    List.of(), null, null);
    ...
    public void setup() {
        ...
        narrativeContext = new ThreadLocalNarrativeContext(new NarrativeTraceConfig(TracingLevel.NARRATIVE));
        summaryContext = new ThreadLocalNarrativeContext(new NarrativeTraceConfig(TracingLevel.SUMMARY));
