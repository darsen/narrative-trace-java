...
public final class ConsoleSummaryReporter {
    ...
    public String formatTestResult(String testName, long durationMs, double clarityScore) {
        return "    ✓ " + testName + " (" + durationMs + "ms, clarity: " + String.format("%.2f", clarityScore) + ")";
    }

    public String formatTestFailure(String testName, long durationMs,
                                    String exceptionType, String location, String traceFilePath) {
        return "    ✗ " + testName + " (" + durationMs + "ms)\n" +
    ...
    public String formatSuiteFooter(int scenarioCount, String outputPath, List<Double> clarityScores) {
        ...
        return "\nNarrativeTrace — Suite complete\n" +
                "  " + scenarioCount + " scenarios recorded\n" +
                "  Clarity: " + highPct + "% high | " + moderatePct + "% moderate | " + lowPct + "% low\n" +
                "  Reports: " + outputPath;
    }
}
