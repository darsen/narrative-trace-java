...
class ProseRendererTest {
    ...
    void renders_parent_with_children() {
        var child1 = new TraceNode(
                new MethodSignature("OrderValidator", "validateCart", List.of(
    ...
    void renders_nested_tree() {
        var grandchild = new TraceNode(
                new MethodSignature("DiscountService", "findDiscounts", List.of(
                        new ParameterCapture("customerId", "\"C-123\"", false)
                )),
                List.of(),
    ...
    void renders_multiple_roots() {
        var root1 = new TraceNode(
                new MethodSignature("OrderService", "placeOrder", List.of()),
                List.of(),
                new TraceOutcome.Returned("\"ok\"")
        );
        var root2 = new TraceNode(
    ...
    void renders_leaf_with_void_return() {
        ...
        assertThat(result).isEqualTo(
                "The order service place order for customerId: \"C-123\".");
    }
}
