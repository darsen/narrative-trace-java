...
class ConfigResolverTest {
    ...
    @Test
    void readsValueFromClasspathPropertiesFile(@org.junit.jupiter.api.io.TempDir Path tempDir) throws Exception {
        Files.writeString(tempDir.resolve("narrativetrace.properties"), "narrativetrace.level=NARRATIVE\n");
    ...
    @Test
    void systemPropertyOverridesFileValue(@org.junit.jupiter.api.io.TempDir Path tempDir) throws Exception {
        Files.writeString(tempDir.resolve("narrativetrace.properties"), "narrativetrace.level=NARRATIVE\n");
        var classLoader = new URLClassLoader(new URL[]{tempDir.toUri().toURL()}, null);
        var resolver = new ConfigResolver(classLoader);
    ...
    @Test
    void throwsWhenMultiplePropertiesFilesOnClasspath(@org.junit.jupiter.api.io.TempDir Path tempDir) throws Exception {
        var dir1 = tempDir.resolve("dir1");
        var dir2 = tempDir.resolve("dir2");
        Files.createDirectories(dir1);
        Files.createDirectories(dir2);
        Files.writeString(dir1.resolve("narrativetrace.properties"), "narrativetrace.level=NARRATIVE\n");
    ...
    void returnsDefaultWhenGetResourcesThrowsIOException() {
        var brokenClassLoader = new ClassLoader() {
            @Override
    ...
    @Test
    void returnsDefaultWhenPropertiesFileIsUnreadable(@org.junit.jupiter.api.io.TempDir Path tempDir) throws Exception {
        ...
        var badUrl = new URL(goodUrl.getProtocol(), goodUrl.getHost(), goodUrl.getPort(),
