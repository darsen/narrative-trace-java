...
public final class ParameterNameResolver {
    ...
    public static List<ParameterCapture> resolve(String[] paramNames, boolean[] redacted,
                                                    Object[] args, ValueRenderer valueRenderer) {
    ...
    public static List<ParameterCapture> resolve(Method method, Object[] args, ValueRenderer valueRenderer) {
